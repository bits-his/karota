...
module.exports.create_incident = function (req, res) {
  var _req$body = req.body,
      ...
      user_name = _req$body$user_name === undefined ? null : _req$body$user_name,
      _req$body$type_of_inc = _req$body.type_of_incident,
      type_of_incident = _req$body$type_of_inc === undefined ? null : _req$body$type_of_inc,
      _req$body$description = _req$body.description,
      description = _req$body$description === undefined ? null : _req$body$description;
...
module.exports.getIncident = function (req, res) {
  var _req$query = req.query,
      ...
      user_name = _req$query$user_name === undefined ? null : _req$query$user_name,
      _req$query$type_of_in = _req$query.type_of_incident,
      type_of_incident = _req$query$type_of_in === undefined ? null : _req$query$type_of_in,
      _req$query$descriptio = _req$query.description,
      description = _req$query$descriptio === undefined ? null : _req$query$descriptio;
